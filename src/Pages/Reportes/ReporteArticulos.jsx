...
class ReporteArticulos extends Component {
  constructor(props) {
    super(props);
     this.state = {      
...
render() {         
    ...
    return ( 
    <>         
      <div className="invoice-boxr" id='printarea'> 
        ...
        <Table className="table-reporteh">
          ...
          <tr>
            ...
            <b>Informe { item.tipo }</b></td>
          </tr>
            
          <tr>
            <td className="text-center"><b>Stock:({item.stock === true ? 'En Stock ': 'Sin Stock'  })</b>
            </td>
          </tr>

          <tr>
          <td className="text-center"><b>N° Items : {cantidad} </b></td>
          </tr>
           </tbody>
        </Table>
        </div>
        ...
        { items.map(item=>(
          <tr key={item.id}>                                  
              ...
              <td >{ item.name }</td>
              <td className="text-center">
              {new Intl.NumberFormat('de-DE',{style: "currency",currency:"BOB"}).format(item.pcompra)}</td>                       
              <td className="text-center">
              {new Intl.NumberFormat('de-DE',{style: "currency",currency:"BOB"}).format(item.pventa)}</td>                       
              <td className="text-center">{ item.minimo}</td>
